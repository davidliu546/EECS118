...
import layout
import catman
from p1_Search import SearchProblem
...
class GraphSearchTest(testClasses.TestCase):
    ...
    def execute(self, grades, moduleDict, solutionDict):
        search = moduleDict['p1_Search']
        searchAgents = moduleDict['p1_SearchAgents']
